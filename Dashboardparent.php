...
<body>
    ...
    function gotoanotherpage() {
            window.location.href = "registerchild.php"; 
        }
    </script>
            ...
            <div class="form-box">
                ...
                <form class="registration-form">
                    <div class="left-side">
                        ...
                        <div class="form-group">
                            <label for="tno">Contact No:</label>
                        </div>
                    </div>

                    <div class="right-side">
                        <div class="form-group">
                            <label for="nic"><?=htmlspecialchars($_SESSION['nic'], ENT_QUOTES)?></label>
                        </div>
                        <div class="form-group">
                            <label for="moh"><?=htmlspecialchars($_SESSION['moh'], ENT_QUOTES)?></label>
                        </div>
                        <div class="form-group">
                            <label for="email"><?=htmlspecialchars($_SESSION['email'], ENT_QUOTES)?></label>
                        </div>
                        <div class="form-group">
                            <label for="wno"><?=htmlspecialchars($_SESSION['wno'], ENT_QUOTES)?></label>
                        </div>
                        <div class="form-group">
                            <label for="tno"><?=htmlspecialchars($_SESSION['tno'], ENT_QUOTES)?></label>
                        </div>
                    </div>
                </form>
                ...
                <ul class="list">
                    <?php if ($children_result && $children_result->num_rows > 0): ?>
                        <?php while ($child = $children_result->fetch_assoc()): ?>
                            <li>
                                <a href="dashboardchi.php?id=<?= htmlspecialchars($child['idchild'], ENT_QUOTES) ?>">
                  ...
                  <a href="registerchild.php"><button type="button" class="btn btn-outline-dark btn-rounded" data-mdb-ripple-init  data-mdb-ripple-color="dark" onclick="gotoanotherpage()">Add Child</button> </a>
